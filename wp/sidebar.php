<aside class="Sidebar">
  ...
  <a href="/contact/" class="bnr-contact"><img src="<?php echo assets_path() ?>img/common/bnr-contact.png" alt="差別化できる商品開発に関する"></a>

  <a href="/whitepaper/" class="bnr-catalog"><img src="<?php echo assets_path() ?>img/common/bnr-catalog.png" alt="機能性原料の活用方法など、商品開発の課題解決に役立つ！ お役立ち資料ダウンロード"></a>
